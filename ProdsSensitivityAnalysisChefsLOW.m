...
% Define a range of values for the coefficient associated with x4
x4_coeff_values = [210000, 555000, 900000]; % corresponding to Low, Mean, High

% Initialize arrays to store results
sensitivity_results = zeros(length(x4_coeff_values), 1);

% Perform sensitivity analysis
for i = 1:length(x4_coeff_values)
    % Update the objective function with the new coefficient for x4
    obj = 35000*x1 + 35000*x2 + 90600*x3 + x4_coeff_values(i)*x4 + 108000*x5 + 120000*x6 + 90000*x7 + 300000*x8 + 9000000*x9 + 150000*x10 + 300000*x11;
...
for i = 1:length(x4_coeff_values)
    fprintf('Coefficient for x4: %d, Objective Function Value: %.2f\n', x4_coeff_values(i), sensitivity_results(i));
end
