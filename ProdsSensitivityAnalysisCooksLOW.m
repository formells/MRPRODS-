...
% Define a range of values for the coefficient associated with x5
x5_coeff_values = [108000, 129000, 150000]; % corresponding to Low, Mean, High

% Initialize arrays to store results
sensitivity_results = zeros(length(x5_coeff_values), 1);

% Perform sensitivity analysis
for i = 1:length(x5_coeff_values)
    % Update the objective function with the new coefficient for x5
    obj = 35000*x1 + 35000*x2 + 90600*x3 + 210000*x4 + x5_coeff_values(i)*x5 + 120000*x6 + 90000*x7 + 300000*x8 + 9000000*x9 + 150000*x10 + 300000*x11;
...
for i = 1:length(x5_coeff_values)
    fprintf('Coefficient for x5: %d, Objective Function Value: %.2f\n', x5_coeff_values(i), sensitivity_results(i));
end
