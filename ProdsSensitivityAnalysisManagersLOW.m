...
% Define a range of values for the coefficient associated with x6
x6_coeff_values = [120000, 165000, 210000]; % corresponding to Low, Mean, High

% Initialize arrays to store results
sensitivity_results = zeros(length(x6_coeff_values), 1);

% Perform sensitivity analysis
for i = 1:length(x6_coeff_values)
    % Update the objective function with the new coefficient for x6
    obj = 35000*x1 + 35000*x2 + 90600*x3 + 210000*x4 + 108000*x5 + x6_coeff_values(i)*x6 + 90000*x7 + 300000*x8 + 9000000*x9 + 150000*x10 + 300000*x11;
...
for i = 1:length(x6_coeff_values)
    fprintf('Coefficient for x6: %d, Objective Function Value: %.2f\n', x6_coeff_values(i), sensitivity_results(i));
end
